...
public class ShowStarred extends ArrayAdapter<Event> {
    ...
    public ShowStarred(Context context, int resource, ArrayList<Event> data) {
    ...
    public View getView(final int position, View row, ViewGroup parent) {
        ...
        starred = event.getStarredStatus();

        // Check if an existing view is being reused, otherwise inflate the view
        // using the event_list_item.xml as a template
        if (row == null)
        {
            row = LayoutInflater.from( getContext()).inflate(R.layout.starred_list_item, parent, false);
        }
